package com.aws.lambda.mysql;import java.sql.Connection;
import java.sql.DriverManager;
import java.sql.SQLException;
import java.sql.Statement;import com.amazonaws.services.lambda.runtime.RequestHandler;
import com.aws.lambda.mysql.data.RequestDetails;
import com.aws.lambda.mysql.data.ResponseDetails;import com.amazonaws.services.lambda.runtime.Context;public class MySqlConect implements RequestHandler<RequestDetails, ResponseDetails>
{
	
	//connecta
	private Connection getConnection() throws SQLException {
		// TODO Auto-generated method stub
				String url = "jdbc:mysql://database.us-west-2.rds.amazonaws.com:3306";
				String username = "";
				String password = "";
